...
public class Usuario {
    ...
    private String cd_Cpf,nm_Usuario,ds_Cargo,ds_Email,ds_Endereco,ds_Cidade,sg_Uf,cd_Cep,cd_Telefone;
    ...
    public Usuario(int cd_Usuario, String cd_Cpf, String nm_Usuario, String ds_Email, String ds_Endereco, String ds_Cidade, String sg_Uf, String cd_Cep, String cd_Telefone) {
    ...
    public Usuario(int cd_Usuario, String cd_Cpf, String nm_Usuario, String ds_Cargo, String ds_Email, String ds_Endereco, String ds_Cidade, String sg_Uf, String cd_Cep, String cd_Telefone) {
        this.cd_Usuario = cd_Usuario;
        this.cd_Cpf = cd_Cpf;
        this.nm_Usuario = nm_Usuario;
